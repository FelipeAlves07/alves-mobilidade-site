  ...
  return (
    <main className="bg-[var(--bg-primary)] text-[var(--foreground)]">
      <section className="relative flex min-h-[420px] items-center overflow-hidden pt-28 md:min-h-[500px]">
        <Image src="/images/servicos-premium.jpg" alt="Solicitar Atendimento" fill priority className="object-cover object-center opacity-30 dark:opacity-40" />
        <div className="absolute inset-0 bg-gradient-to-r from-[var(--bg-primary)]/20 via-[var(--bg-primary)]/5 to-transparent dark:from-[var(--bg-primary)]/85 dark:via-[var(--bg-primary)]/50" />
