  ...
  return (
    <main className="overflow-hidden bg-[var(--bg-primary)] text-[var(--foreground)]">
      ...
      <section className="relative flex min-h-screen items-center overflow-hidden">
        <Image src="/images/hero-byd.jpg" alt="Alves Mobilidade Executiva" fill priority className="object-cover object-center opacity-55" />
        <div className="absolute inset-0 bg-gradient-to-r from-[var(--bg-primary)]/85 via-[var(--bg-primary)]/30 to-transparent" />
