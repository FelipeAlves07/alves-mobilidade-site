  ...
  return (
    <main className="bg-[var(--bg-primary)] text-[var(--foreground)]">
      <section className="relative flex min-h-[500px] items-center overflow-hidden pt-28 md:min-h-[600px]">
        <Image src="/images/servicos-premium.jpg" alt="Serviços Alves Mobilidade" fill priority className="object-cover object-center opacity-50" />
        <div className="absolute inset-0 bg-gradient-to-r from-[var(--bg-primary)]/85 via-[var(--bg-primary)]/40 to-transparent" />
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-5 lg:px-8">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-4 text-4xl font-black leading-tight md:text-5xl lg:text-6xl">Mobilidade executiva para todos os momentos.</h1>
